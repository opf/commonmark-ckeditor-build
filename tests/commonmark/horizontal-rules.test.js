...
describe('CommonMarkProcessor', () => {
	...
	describe('horizontal rules', () => {
		describe('dashes', () => {
			it('#1', () => {
				testDataProcessor('---', '<hr></hr>', hrMarkdownFlavour);
			});
		...
		describe('underscores', () => {
			it('#1', () => {
				testDataProcessor('___', '<hr></hr>', hrMarkdownFlavour);
			});
		...
		describe('underscores with spaces', () => {
			it('#1', () => {
				testDataProcessor('_ _ _', '<hr></hr>', hrMarkdownFlavour);
			});
