	...
	describe('links', () => {
		...
		it('should process inline links', () => {
			testDataProcessor(
				...
				// When converting back, the URL will be normalized to the full URL.
		...
		it('should process inline links with title', () => {
			testDataProcessor(
				...
				// When converting back, the URL will be normalized to the full URL.
				'[URL and title](http://localhost/url/ "title")',
			);
		});
		...
		it('should process inline links with title preceded by two spaces', () => {
			testDataProcessor(
				...
				// the URL will be normalized to the full URL.
				'[URL and title](http://localhost/url/ "title preceded by two spaces")'
			);
		});
		...
		it('should process inline links with title preceded by tab', () => {
			testDataProcessor(
				...
				// the URL will be normalized to the full URL.
				'[URL and title](http://localhost/url/ "title preceded by tab")'
			);
		});
		...
		it('should process inline links with title that has spaces afterwards', () => {
			testDataProcessor(
				...
				// the URL will be normalized to the full URL.
				'[URL and title](http://localhost/url/ "title has spaces afterward")'
			);
		});
		...
		it('should process reference links', () => {
			testDataProcessor(
				...
				// The URL will be normalized to the full URL.
				'Foo [bar](http://localhost/url/ "Title").'
			);
		});
		...
		it('should process reference links - with embedded brackets', () => {
			testDataProcessor(
				...
				'With [embedded \\[brackets\\]](http://localhost/url/).'
			);
		});
		...
		it('should process reference links - with reference indented once', () => {
			testDataProcessor(
				...
				'Indented [once](http://localhost/url).'
			);
		});
		...
		it('should process reference links - with reference indented twice', () => {
			testDataProcessor(
				...
				'Indented [twice](http://localhost/url).'
			);
		});
		...
		it('should process reference links - with reference indented three times', () => {
			testDataProcessor(
				...
				'Indented [trice](http://localhost/url).'
			);
		});
		...
		it('should process reference links nested in brackets #1', () => {
			testDataProcessor(
				...
				'\\[a reference inside [this](http://localhost/foo)\\]'
			);
		});
		...
		it('should not process reference links when title is same as reference but reference is different', () => {
			testDataProcessor(
				...
				'[this](http://localhost/something/else/)'
			);
		});
